...
import com.example.watch_hub.databinding.ActivityLuxuryBinding;
...
ActivityLuxuryBinding binding;
StoreAdapter storeAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
     binding = ActivityLuxuryBinding.inflate(getLayoutInflater());
        ...
        FirebaseFirestore.getInstance().collection("products").whereEqualTo("category",VAL)
                .get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        binding.casual.setLayoutManager(new GridLayoutManager(luxury.this,2));
