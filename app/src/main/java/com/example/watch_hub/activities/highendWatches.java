...
import com.example.watch_hub.databinding.ActivityHighendWatchesBinding;
...
public class highendWatches extends AppCompatActivity {
ActivityHighendWatchesBinding binding;
StoreAdapter storeAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       binding = ActivityHighendWatchesBinding.inflate(getLayoutInflater());
        ...
        FirebaseFirestore.getInstance().collection("products").whereEqualTo("category",VAL)
                .get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        binding.casual.setLayoutManager(new GridLayoutManager(highendWatches.this,2));
