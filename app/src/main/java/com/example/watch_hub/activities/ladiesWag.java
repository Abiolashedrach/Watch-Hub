...
import com.example.watch_hub.databinding.ActivityLadiesWagBinding;
...
public class ladiesWag extends AppCompatActivity {
    StoreAdapter storeAdapter;
    ActivityLadiesWagBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityLadiesWagBinding.inflate(getLayoutInflater());
        ...
        FirebaseFirestore.getInstance().collection("products").whereEqualTo("category",VAL)
                .get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        binding.casual.setLayoutManager(new GridLayoutManager(ladiesWag.this,2));
